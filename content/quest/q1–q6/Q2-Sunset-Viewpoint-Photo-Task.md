# Q2 — Sunset Viewpoint Photo Task
...
- slug: `sunset-viewpoint-photo-task`
- title: `Sunset Viewpoint Photo Task`
...
- start_cta_label: `Начать фото-задание`
- continue_cta_label: `Продолжить задание`
...
### Cover image
- cover_image_key: `quests/phuket/sunset-viewpoint-photo-task/cover.jpg`
- cover_image_alt: `Закатный вид с обзорной площадки на Пхукете`
- cover_image_hint: `sunset viewpoint / hilltop / golden hour`

### Gallery images
- gallery_image_01_key: `quests/phuket/sunset-viewpoint-photo-task/gallery/01.jpg`
- gallery_image_01_alt: `Дорожка к обзорной площадке на закате`

- gallery_image_02_key: `quests/phuket/sunset-viewpoint-photo-task/gallery/02.jpg`
...
- seo_title: `Sunset Viewpoint Photo Task — Quest Asia`
...
#### Step media
- step_image_key: `quests/phuket/sunset-viewpoint-photo-task/steps/step_sunset_001/01.jpg`
...
#### Step media
- step_image_key: `quests/phuket/sunset-viewpoint-photo-task/steps/step_sunset_002/01.jpg`
...
- user_instruction_short: `Коротко подтвердите завершение задания и дождитесь результата проверки.`
...
#### Step media
- step_image_key: `quests/phuket/sunset-viewpoint-photo-task/steps/step_sunset_003/01.jpg`
- step_image_alt: `Финальная точка фото-задания на закате`
- step_image_hint: `sunset close / task confirmation / evening finish`
