...
| --- | --- | --- | --- |
| G1 | Authorial Post runtime `NOT_ESTABLISHED` | P4/P5 rows are canon targets; interaction edges are planning-only | NO — expected |
| G2 | Source Reference runtime `NOT_ESTABLISHED` | P5 evidence row intentionally empty until WS-3 auth | NO — expected |
...
- P4 and P5 remain `NOT_ESTABLISHED` — matrix edges for them are governance targets only;
