...
export const rfOfferClaimCopy = {
  ...
  vipRequired: 'Для этого ваучера RF runtime требует VIP-статус. Это не оплата объекта и не бронь в Rielt.',
  insufficientBalance: 'Сейчас этот ваучер недоступен для получения.',
  spendTemporarilyUnavailable: 'Ваучер временно недоступен для получения. Попробуйте позже.',
