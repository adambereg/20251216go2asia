...
export const rfMyVouchersPageContent = {
  ...
  meaningBody:
    'Ваучеры показываются как фактологический read-only слой: статус, spend semantics (бесплатный, Points-compatible free или списание Points), повторяемость и источник через PRO при подтверждённой атрибуции. Это не раздел выплат, наград или комиссий.',
