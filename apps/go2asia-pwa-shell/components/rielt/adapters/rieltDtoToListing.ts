...
export function rieltDtoToListing(dto: RieltListingDto): Listing {
  ...
  return {
    ...
    rfPartnerId: dto.rfPartnerId ?? null,
    rfOfferId: dto.rfOfferId ?? null,
    status: 'approved',
...
export function mergeSeedPresentationOverlay(base: Listing, overlay: Listing | null | undefined): Listing {
  ...
  return {
    ...
    rfPartnerId: base.rfPartnerId ?? overlay.rfPartnerId ?? null,
    rfOfferId: base.rfOfferId ?? overlay.rfOfferId ?? null,
