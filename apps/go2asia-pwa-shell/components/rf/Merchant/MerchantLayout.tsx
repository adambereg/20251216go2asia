        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[240px_1fr]">
            ...
            <div className="sticky top-6">
              <div className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm">
                ...
                <p className="mb-4 text-[11px] leading-snug text-slate-500">
                  Рабочие разделы доступны сразу; будущие возможности помечены как soon.
                </p>
                <MerchantNav />
              </div>
            </div>
          ...
          <main className="min-w-0">
            <p className="mb-6 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-600">
              Данные подгружаются с RF API под вашим аккаунтом Clerk. Доступны создание партнёра,
              создание/активация офферов и погашение ваучера.
            </p>
            {children}
          </main>
        </div>
