 ...
 */
import type { QuestMetadataGalleryItemResponse } from "./questMetadataGalleryItemResponse";

export interface QuestMetadataMediaResponse {
  /** @nullable */
  cardMediaAlt?: string | null;
  /** @nullable */
  cardMediaKey?: string | null;
  galleryMedia?: QuestMetadataGalleryItemResponse[];
  /** @nullable */
