...
export type QuestStatusFilterParameter =
  (typeof QuestStatusFilterParameter)[keyof typeof QuestStatusFilterParameter];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const QuestStatusFilterParameter = {
  draft: "draft",
  published: "published",
  archived: "archived",
} as const;
