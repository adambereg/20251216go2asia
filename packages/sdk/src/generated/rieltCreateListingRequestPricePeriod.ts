...
export type RieltCreateListingRequestPricePeriod =
  (typeof RieltCreateListingRequestPricePeriod)[keyof typeof RieltCreateListingRequestPricePeriod];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RieltCreateListingRequestPricePeriod = {
  month: "month",
  day: "day",
  total: "total",
} as const;
