 ...
 */
import type { RfMerchantVoucherActivitySummaryResponseScope } from "./rfMerchantVoucherActivitySummaryResponseScope";
import type { RfMerchantVoucherActivitySummary } from "./rfMerchantVoucherActivitySummary";

export interface RfMerchantVoucherActivitySummaryResponse {
  generatedAt: string;
  partnerId: string;
  scope: RfMerchantVoucherActivitySummaryResponseScope;
