-- ============================================================================
-- 0023_atlas_bangkok_backfill_target_hotfix.sql
-- Narrow hotfix: rerun Bangkok backfill with staging-compatible target matching
-- Scope: only Thailand/Bangkok pilot records from 0022
-- ============================================================================
...
WHERE p.slug = pm.place_slug
  ...
  AND (p.city_id = tc.city_id OR p.city_id IN ('bkk', 'bangkok') OR p.city_id IS NULL OR p.city_id = '');
