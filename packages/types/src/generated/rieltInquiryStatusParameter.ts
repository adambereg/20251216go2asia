...
export type RieltInquiryStatusParameter =
  (typeof RieltInquiryStatusParameter)[keyof typeof RieltInquiryStatusParameter];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RieltInquiryStatusParameter = {
  new: "new",
  viewed: "viewed",
  closed: "closed",
} as const;
