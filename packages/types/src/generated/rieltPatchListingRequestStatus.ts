...
export type RieltPatchListingRequestStatus =
  (typeof RieltPatchListingRequestStatus)[keyof typeof RieltPatchListingRequestStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RieltPatchListingRequestStatus = {
  draft: "draft",
  published: "published",
} as const;
