 ...
 */
import type { RfInternalVoucherDiagnosticsProLinkRelationStatus } from "./rfInternalVoucherDiagnosticsProLinkRelationStatus";

export interface RfInternalVoucherDiagnosticsProLinkRelation {
  id: string;
  partnerId: string;
  proUserId: string;
  /** @nullable */
  shareCodeMasked: string | null;
  status: RfInternalVoucherDiagnosticsProLinkRelationStatus;
}
