...
export type ReferralEarningsItemStatus =
  (typeof ReferralEarningsItemStatus)[keyof typeof ReferralEarningsItemStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ReferralEarningsItemStatus = {
  pending: "pending",
  activated: "activated",
  rewarded: "rewarded",
