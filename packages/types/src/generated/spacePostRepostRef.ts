 ...
 */
import type { SpaceResolvedRepostPreview } from "./spaceResolvedRepostPreview";
import type { SpaceRepostTargetType } from "./spaceRepostTargetType";

export interface SpacePostRepostRef {
  /** @nullable */
  resolvedPreview?: SpaceResolvedRepostPreview;
  targetId: string;
  targetType: SpaceRepostTargetType;
}
