 ...
 */
import type { RieltNearbyAnchor } from "./rieltNearbyAnchor";
import type { RieltNearbyListing } from "./rieltNearbyListing";
import type { RieltPagination } from "./rieltPagination";

export interface RieltNearbyListResponse {
  anchor: RieltNearbyAnchor;
  items: RieltNearbyListing[];
  pagination: RieltPagination;
}
