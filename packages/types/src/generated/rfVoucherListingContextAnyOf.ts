 ...
 */
import type { RfVoucherListingContextAnyOfSource } from "./rfVoucherListingContextAnyOfSource";

export type RfVoucherListingContextAnyOf = {
  listingId: string;
  /** @nullable */
  listingTitle: string | null;
  source: RfVoucherListingContextAnyOfSource;
};
