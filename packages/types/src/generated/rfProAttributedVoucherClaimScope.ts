...
export type RfProAttributedVoucherClaimScope =
  (typeof RfProAttributedVoucherClaimScope)[keyof typeof RfProAttributedVoucherClaimScope];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RfProAttributedVoucherClaimScope = {
  partner: "partner",
  listing: "listing",
} as const;
