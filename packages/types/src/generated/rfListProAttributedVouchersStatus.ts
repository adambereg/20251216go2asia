...
export type RfListProAttributedVouchersStatus =
  (typeof RfListProAttributedVouchersStatus)[keyof typeof RfListProAttributedVouchersStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RfListProAttributedVouchersStatus = {
  claimed: "claimed",
  redeemed: "redeemed",
  cancelled: "cancelled",
} as const;
