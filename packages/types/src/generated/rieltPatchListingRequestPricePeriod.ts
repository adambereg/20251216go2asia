...
export type RieltPatchListingRequestPricePeriod =
  (typeof RieltPatchListingRequestPricePeriod)[keyof typeof RieltPatchListingRequestPricePeriod];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RieltPatchListingRequestPricePeriod = {
  month: "month",
  day: "day",
  total: "total",
} as const;
