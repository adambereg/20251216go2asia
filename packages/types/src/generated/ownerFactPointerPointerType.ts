...
export type OwnerFactPointerPointerType =
  (typeof OwnerFactPointerPointerType)[keyof typeof OwnerFactPointerPointerType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OwnerFactPointerPointerType = {
  OWNER_FACT_POINTER: "OWNER_FACT_POINTER",
} as const;
