 ...
 */
import type { ReactionsErrorResponse } from "./reactionsErrorResponse";

/**
 * Conflict (for example idempotency key reuse with different payload)
 */
export type ReactionsConflictResponse = ReactionsErrorResponse;
